...
public:
    ...
    void incrementAngle(double dtheta = 3);      // increment the angle of the cannon by dtheta
    void decrementAngle(double dtheta = 3);      // decrement the angle of the cannon by dtheta
